...
#define  M8266WIFI_nRESET_GPIO_RCC_CLOCK_EN				  __HAL_RCC_GPIOA_CLK_ENABLE();//RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOB, ENABLE)
#define  M8266WIFI_nRESET_GPIO											GPIOA//GPIOB
#define  M8266WIFI_nRESET_PIN												GPIO_PIN_2//GPIO_Pin_12
...
#define  M8266WIFI_SPI_nCS_GPIO_RCC_CLOCK_EN				__HAL_RCC_GPIOB_CLK_ENABLE();
